...
‘6’ + 3 ** 0; // 1,  6 неявно перетворюється. 6+3=9, але потім 9 в 0 спепені це 1
...
false && (false || true); // false - cgjxfnre у скобках повертає перше існінне значення true, потім && повертає false - перше ложне
